...
export default function Experience() {
  ...
  const [cockpitCar,  setCockpitCar]  = useState(null);
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="font-orbitron text-xs tracking-[0.35em] uppercase" style={{ color: "rgba(200,169,110,0.8)" }}>
              Experience
            </span>
            <span className="block h-px w-16" style={{ background: "rgba(200,169,110,0.6)" }} />
          </motion.div>
          ...
          >
            <button
              ...
              style={{ border: "1px solid rgba(200,169,110,0.6)", color: "#C8A96E", background: "transparent" }}
            >
              <span className="absolute inset-0 translate-x-[-101%] group-hover:translate-x-0 transition-transform duration-500 ease-[cubic-bezier(0.76,0,0.24,1)]"
          ...
          >
            <span className="font-rajdhani text-xs tracking-[0.25em] uppercase" style={{ color: "rgba(200,169,110,0.4)" }}>
              Scroll
            </span>
            <motion.div
              animate={{ y: [0, 6, 0] }}
      ...
      {/* Drive Modal — CockpitSim overlays on top from within DriveModal */}
      <DriveModal
        isOpen={modalOpen}
      ...
      {/* Standalone CockpitSim for when triggered outside DriveModal */}
      <CockpitSim
        isOpen={cockpitOpen}
        onClose={() => { setCockpitOpen(false); setCockpitCar(null); }}
        car={cockpitCar}
      />
    </>
  );
